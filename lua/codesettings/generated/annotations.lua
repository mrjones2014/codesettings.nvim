...
-- apply fixes based on go:fix comment directives
-- 
...
-- simplify code by using modern constructs
-- 
...
-- (Experimental) `"run_govulncheck"`: Run govulncheck (legacy)
-- 
