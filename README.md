...
- [x] [cssls](https://github.com/microsoft/vscode/tree/main/extensions/css-language-features/package.json) (supports i18n)
...
- [x] [graphql](https://github.com/graphql/graphiql/refs/heads/tree/main/packages/vscode-graphql/package.json)
...
- [x] [html](https://github.com/microsoft/vscode/tree/main/extensions/html-language-features/package.json) (supports i18n)
...
- [x] [jsonls](https://github.com/microsoft/vscode/tree/master/extensions/json-language-features/package.json) (supports i18n)
...
- [x] [ltex](https://github.com/valentjn/vscode-ltex/tree/develop/package.json) (supports i18n)
- [x] [lua_ls](https://github.com/LuaLS/vscode-lua/tree/master/package.json) (supports i18n)
...
- [x] [omnisharp](https://github.com/OmniSharp/omnisharp-vscode/tree/master/package.json) (supports i18n)
...
- [x] [tinymist](https://github.com/Myriad-Dreamin/tinymist/refs/heads/tree/main/editors/vscode/package.json) (supports i18n)
- [x] [ts_ls](https://github.com/microsoft/vscode/tree/main/extensions/typescript-language-features/package.json) (supports i18n)
- [x] [typst_lsp](https://github.com/nvarner/typst-lsp/refs/heads/tree/master/editors/vscode/package.json)
- [x] [volar](https://github.com/vuejs/language-tools/tree/master/extensions/vscode/package.json) (supports i18n)
...
<<<<<<< conflict 1 of 1
+++++++ lqouommn f234f871 "chore(build): auto-generate schemas" (rebase destination)
%%%%%%% diff from: sppmyoml 5905da98 "chore(ci): auto-generate vimdoc" (parents of rebased revision)
\\\\\\\        to: yuywnoum 2b697016 "feat(schema): Add support for GraphQL LSP" (rebased revision)
